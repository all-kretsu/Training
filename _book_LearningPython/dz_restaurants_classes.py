...
class Reastaurants():
	...
	def describe_rest(self):
		print(f'Reastaurant {self.rest_name} have {self.cuisine_type}.')

	def open_rest(self):
		print(f'Reastaurant {self.rest_name} is open.')

chinese_rest = Reastaurants('Red Dragon', 'chinese cuisine')
italian_rest = Reastaurants('Napoli', 'italian cuisine')
mexican_rest = Reastaurants('Amigos', 'mexican cuisine')
